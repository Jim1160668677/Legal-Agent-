...
export const INTENT_DEFS: IntentDef[] = [
  // 1. legal_qa —— 法律问答，法条/概念解释，路由 rule/knowledge
  {
    ...
    keywords: [
      ...
      { word: '民法典', weight: 0.6 },
      { word: '刑法', weight: 0.6 },
      // 通用疑问词降权（避免「什么是人工智能」误命中），靠法律领域词补强
      { word: '是什么', weight: 0.3 },
      { word: '什么是', weight: 0.3 },
      { word: '什么叫', weight: 0.3 },
      { word: '什么意思', weight: 0.3 },
      { word: '解释一下', weight: 0.3 },
      { word: '是指', weight: 0.3 },
      { word: '怎么理解', weight: 0.4 },
      { word: '不可抗力', weight: 0.6 },
      // 法律概念强信号（A4-W4 评测补强）
      { word: '继承人', weight: 0.8 },
      { word: '法定继承', weight: 0.9 },
      { word: '无权代理', weight: 0.9 },
      { word: '表见代理', weight: 0.9 },
      { word: '撤销权', weight: 0.8 },
      { word: '法律后果', weight: 0.7 },
      { word: '诚实信用', weight: 0.8 },
      { word: '人格权', weight: 0.8 },
      { word: '归责原则', weight: 0.9 },
      { word: '违约责任', weight: 0.8 },
      { word: '侵权责任', weight: 0.8 },
    ],
    patterns: [
      { regex: '《[^》]{1,12}法》', weight: 0.7 },
      { regex: '第[零一二三四五六七八九十百千万0-9]+条.{0,4}规定', weight: 0.8 },
      { regex: '民法典.{0,4}(第.{1,4}条|关于|规定)', weight: 0.8 },
    ],
  },
  ...
  // 4. case_analysis —— 案件分析（能否胜诉/判多重），路由 llm
  {
    ...
    keywords: [
      ...
      { word: '能告赢', weight: 0.8 },
      { word: '能告倒', weight: 0.7 },
      // A4-W4 评测补强：覆盖"能否起诉/要赔偿/维权"等具体诉求
      { word: '能起诉吗', weight: 0.7 },
      { word: '能要赔偿', weight: 0.9 },
      { word: '能要回来', weight: 0.8 },
      { word: '能变更', weight: 0.8 },
      { word: '怎么维权', weight: 0.9 },
      { word: '维权', weight: 0.7 },
      { word: '合理吗', weight: 0.7 },
      { word: '判多重', weight: 0.9 },
      { word: '退一赔三', weight: 0.9 },
      { word: '拖欠工资', weight: 0.8 },
      { word: '不还', weight: 0.6 },
      { word: '受伤', weight: 0.6 },
      { word: '扰民', weight: 0.7 },
      { word: '漏水', weight: 0.6 },
      { word: '事故车', weight: 0.8 },
      { word: '不发货', weight: 0.7 },
      { word: '不让我看', weight: 0.7 },
    ],
    patterns: [
      { regex: '(能|可以|有没有).{0,4}(赢|胜诉|把握|胜算)', weight: 0.9 },
      { regex: '(能|可以).{0,4}(要赔偿|要回来|变更|退)', weight: 0.8 },
      { regex: '怎么.{0,4}(维权|办|处理)', weight: 0.7 },
      { regex: '(判|坐).{0,2}(多少年|多重)', weight: 0.9 },
    ],
  },
  ...
  // 5. case_reasoning —— 案件推理（v2.3，IRAC/相似案例），路由 reasoning
  {
    ...
    keywords: [
      ...
      { word: '裁判', weight: 0.5 },
      { word: '案件', weight: 0.4 },
      // A4-W4 评测补强：覆盖"分析本案"/"法理学"/"法律关系"/"争议焦点"
      { word: '分析', weight: 0.5 },
      { word: '法理学', weight: 0.9 },
      { word: '法理', weight: 0.7 },
      { word: '法律关系', weight: 0.9 },
      { word: '争议焦点', weight: 0.9 },
      { word: '本案', weight: 0.7 },
      { word: '推演', weight: 0.8 },
      { word: 'IRAC', weight: 1.0 },
    ],
    patterns: [
      { regex: '(相似|类似|同类).{0,2}(案例|案件|判例)', weight: 1.0 },
      { regex: '怎么.{0,4}辩护', weight: 0.8 },
      { regex: '(分析|推演).{0,4}(本案|案件|这个)', weight: 0.9 },
      { regex: '(法理|IRAC).{0,4}(分析|方法|角度)', weight: 0.9 },
      { regex: '(法律关系|争议焦点|裁判结果)', weight: 0.9 },
    ],
  },
  ...
  // 7. tool_invoke —— 工具调用（v2.2），路由 tool
  {
    ...
    patterns: [
      ...
      // 「期限」单独出现不构成工具调用，需配合「计算/查询」才命中
      { regex: '(期限|期间).{0,4}(多少|怎么算|计算)', weight: 0.9 },
    ],
    toolIdMap: {
